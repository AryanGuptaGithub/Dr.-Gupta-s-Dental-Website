...
const cases = [
  { before: '/images/whitening-before-1.webp', after: '/images/whitening-after-1.webp', title: 'Laser Whitening' },
  { before: '/images/whitening-before-2.webp', after: '/images/whitening-after-2.webp', title: 'Combo Package' },
  { before: '/images/whitening-before-3.webp', after: '/images/whitening-after-3.webp', title: 'Take-Home Kit' },
]

export const WhiteningGallery = () => {
    ...
    <section className="py-section bg-white">
      <div className="max-w-5xl mx-auto px-6">
        <div className="text-center mb-12">
          <p className="text-gold uppercase tracking-widest text-sm font-medium mb-4">Real Results</p>
          <h2 className="font-serif text-h2 text-teal">Whitening Transformations</h2>
          <p className="text-warm-grey mt-4">Drag the slider to see the shade difference</p>
        </div>
        ...
        >
          <Image src={current.after} alt="After teeth whitening" fill className="object-cover" />
          <div className="absolute top-0 left-0 h-full overflow-hidden" style={{ width: `${position}%` }}>
            <Image src={current.before} alt="Before teeth whitening" fill className="object-cover" />
