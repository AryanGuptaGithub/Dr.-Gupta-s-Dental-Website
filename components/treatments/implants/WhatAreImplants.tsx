      ...
      <div className="grid md:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <div className="space-y-4 text-warm-grey leading-relaxed">
            <p>
              A dental implant is a small titanium post that acts as an
              artificial tooth root. It's surgically placed into your jawbone,
              where it fuses naturally with the bone over a few months. Once
              healed, a custom‑made crown is attached — giving you a tooth that
              looks, feels, and functions exactly like a natural one.
            </p>
            <p>
              Unlike dentures or bridges, implants are a permanent solution.
              They don't slip, don't affect neighboring teeth, and with proper
        ...
        >
          <Image
            src="/images/Dental-implant.jpeg"
