...
const cases = [
  { before: '/images/implant-before-1.webp', after: '/images/implant-after-1.webp', title: 'Single Implant' },
  { before: '/images/implant-before-2.webp', after: '/images/implant-after-2.webp', title: 'Implant Bridge' },
  { before: '/images/implant-before-3.webp', after: '/images/implant-after-3.webp', title: 'Full Mouth' },
]

export const ImplantBeforeAfter = () => {
    ...
    <section className="py-section bg-white">
      <div className="max-w-5xl mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <h2 className="font-serif text-h2 text-teal">Implant Transformations</h2>
        </div>
        ...
        >
          <Image src={current.after} alt="After implant" fill className="object-cover" />
          <div className="absolute top-0 left-0 h-full overflow-hidden" style={{ width: `${position}%` }}>
            <Image src={current.before} alt="Before implant" fill className="object-cover" />
